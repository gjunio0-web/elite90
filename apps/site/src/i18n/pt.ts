// --- ELITE90 PRO · Traduções PT-BR
export const pt = {
  // META
  meta: {
    title: "Coach Ruiz | ELITE90 PRO - Consultoria de Alta Performance Física",
    description:
  ...
  schedule: {
    ...
    eyebrow: "O programa",
    title: "Cronograma do Programa ELITE90 PRO",
    phases: [
      {
        number: "01",
        title: "Primeiro Mês",
        items: ["+Massa magra", "−Percentual de gordura"],
      },
      {
        number: "02",
        title: "Segundo Mês",
        items: ["Ajuste fino", "Alinhamento de rota"],
      },
      {
        number: "03",
        title: "Terceiro Mês",
        items: ["Definição muscular", "Finalização do físico"],
      },
    ],
  },
  ...
  pillars: {
    ...
    eyebrow: "O método",
    title: "Pilares do Programa ELITE90 PRO",
    intro:
    ...
    confluence:
      "O abdômen definido e a musculatura imponente não são promessas. São consequências.",
  },
  ...
  objection: {
    ...
    paragraphs: [
      ...
      "Quase 90% dos mentorados têm entre 35 e 55 anos. O ELITE90 PRO foi construído especificamente para este perfil.",
    ],
  },
  ...
  results: {
    ...
    titleAccent: "obtidos através do Programa ELITE90 PRO",
    beforeLabel: "Antes",
    afterLabel: "Depois",
    readMore: "Ver mais",
    readLess: "Ver menos",
  ...
  process: {
    ...
    title: "Passo a passo para participar do Programa ELITE90 PRO",
    steps: [
      {
        who: "Você",
        title: "Ficha de aplicação online",
        body: "3 perguntas, 2 minutos.",
      },
      {
        who: "Ruiz",
      ...
      {
        who: "Você + Ruiz",
        title: "Entrevista de aprovação por vídeo",
        body: "",
      },
      {
        who: "Você",
        title: "Formulário de triagem clínica",
        body: "Base para o endocrinologista.",
      },
      {
        who: "Ruiz",
        title: "Guia de exames laboratoriais",
        body: "Enviado via PDF.",
      },
      {
        who: "Você + Ruiz",
        title: "Videochamada de imersão",
        body: "Análise dos exames.",
      },
      {
        who: "Ruiz + Equipe",
        title: "Protocolo alimentar e plano de treino entregues",
        body: "",
      },
      {
        who: "Contínuo",
        title: "Suporte psicológico + coach online",
        body: "Pelos 90 dias.",
      },
    ],
  },
  ...
  testimonials: {
    ...
    items: [
      {
        name: "Bruno Ferraz",
        role: "Empresário · Mister Brasil 2021",
        metric: "+17 kg de massa magra · BF mantido baixo · Título Mister Brasil",
        image: "/images/testimonials/depoente-bruno.webp",
        text: "Meu nome é Bruno Ferraz, sou empresário no ramo de vitaminas, Mister Brasil 2021, jogador de Poker e Xadrez, julgo muito importante a saúde do corpo e mente, logo, desde meados de 2019, onde conheci o excelente profissional e coach Fernando Ruiz, venho obtendo excelentes resultados físicos, saindo de 85 kg para 102 kg, mantendo a qualidade muscular e baixo percentual de gordura, me sagrando Mister Brasil após uma preparação bem-sucedida.",
      },
      {
        name: "Renan Serrano",
        role: "Empresário",
        metric: "−10 kg de gordura",
        image: "/images/testimonials/depoente-renan.webp",
        text: "Me chamo Renan Serrano, sou empresário, e um dos felizardos que tem o Coach Fernando Ruiz ao meu lado. Eu estava precisando muito de uma pessoa igual o Fernando e um grande amigo me apresentou, foi a melhor escolha para á minha saúde! Estava pesando 112kg com muita gordura localizada, e com a ajuda do Ruiz reduzi 10kg de gordura e agora estou no processo de ganho massa magra.",
      },
      {
        name: "Michel de Barcelos Santos",
        role: "Juiz Federal do Trabalho · São Paulo",
      ...
      },
      {
        ...
        metric: '"Ele nunca entrega uma fórmula pronta"',
      ...
      },
      {
        ...
        image: "/images/testimonials/depoente-jorge.webp",
  ...
  content: {
    ...
    filters: {
      ...
      searchAriaLabel: "Buscar conteúdo por palavra-chave",
      clearFilters: "Limpar filtros",
    },
    empty: {
      title: "Nenhum conteúdo com esses filtros",
      body: "Tente remover algum filtro ou ajustar a busca — ainda há conteúdos disponíveis fora dessa combinação.",
      clearCta: "Limpar filtros",
    },
    loadMore: "Carregar mais conteúdos",
    showLess: "Mostrar menos",
    notifyMe: "Seja parte do Programa ELITE90 PRO e acompanhe os conteúdos novos por lá",
    ...
    items: [
      {
        title: "Guia de poses para Men's Physique",
        body: "Guia técnico de apresentação de palco: comportamento e postura, a biomecânica de cada pose — frontal, lateral, de costas e as transições — e como treinar poses em off e pré-contest.",
        meta: "E-book · 16 páginas · PDF",
        origin: "curated",
        tipo: "guia",
        state: "live",
      ...
      },
      {
        ...
        body: "Manual técnico de apresentação para a categoria: apresentação individual, giros de frente e de costas, escolha de ângulos, transições e como treinar posing em off-season e pré-contest. Separa as exigências da NPC das orientações do Coach.",
        meta: "Cartilha · 5 páginas · PDF",
        origin: "original",
        tipo: "guia",
        state: "live",
      ...
      {
        title: "Cartilha de posing — NPC Classic Physique",
        body: "Manual técnico da categoria clássica: quartos de volta e as cinco poses compulsórias, escolha da pose clássica favorita, rotina de até 60 segundos e checklist de prontidão antes de competir.",
        meta: "Cartilha · 5 páginas · PDF",
        origin: "original",
        tipo: "guia",
        state: "live",
      ...
      {
        title: "Cartilha de posing — NPC Men's Bodybuilding",
        body: "Manual técnico da categoria: rodada relaxada, apresentação individual, as oito poses compulsórias, a Most Muscular favorita, comparações e transições, com checklist final de prontidão.",
        meta: "Cartilha · 7 páginas · PDF",
        origin: "original",
        tipo: "guia",
        state: "live",
      ...
      {
        title: "Podcast ELITE90 PRO · Ep. 02 — Recuperação para rotina corrida",
      ...
      },
      {
        ...
        body: "Como manter o programa ELITE90 PRO em dia mesmo com semanas inteiras fora de casa.",
      ...
      {
        title: "Sono e desempenho: o que a ciência diz",
        body: "Seleção do Coach sobre estudos recentes ligando qualidade de sono a resultado de treino.",
        meta: "Artigo · Leitura de 8 min",
        origin: "curated",
        tipo: "artigo",
        state: "soon",
        href: "#",
      ...
      {
        title: "Nutrição prática para dias de reunião",
        body: "Como montar refeições que sustentam o treino sem depender de cozinhar em casa.",
        meta: "Guia · PDF",
        origin: "original",
        tipo: "guia",
        state: "soon",
      ...
      {
        title: "Como montar seu home gym executivo",
        body: "Seleção do Coach sobre equipamentos essenciais para treinar em casa com pouco espaço.",
        meta: "Vídeo · 12 min",
        origin: "curated",
        tipo: "video",
        state: "soon",
      ...
      {
        title: "Mobilidade de ombro para quem trabalha sentado",
        body: "Sequência curta para compensar horas de reunião e computador.",
        meta: "Vídeo · 9 min",
        origin: "original",
        tipo: "video",
        state: "soon",
      ...
      {
        title: "Suplementação: o que vale a pena depois dos 40",
        body: "Seleção do Coach sobre o que tem respaldo de evidência e o que é só marketing.",
        meta: "Artigo · Leitura de 7 min",
        origin: "curated",
        tipo: "artigo",
        state: "soon",
        href: "#",
      ...
      {
        title: "Podcast ELITE90 PRO · Ep. 03 — Disciplina sem obsessão",
      ...
      {
        title: "Avaliação postural: o que observar em casa",
        body: "Seleção do Coach com um roteiro simples de autoavaliação antes da mentoria.",
        meta: "Guia · PDF",
        origin: "curated",
        tipo: "guia",
        state: "soon",
      ...
      {
        title: "Treino mínimo eficaz em semanas de crise",
        body: "O que priorizar quando a agenda não permite a rotina completa do programa.",
        meta: "Vídeo · 10 min",
        origin: "original",
        tipo: "video",
        state: "soon",
  ...
  partners: {
    ...
    items: [
      ...
      {
        name: "Oficial Farma",
        description: "Parceiro farmacêutico para manipulação de protocolos individualizados.",
        logo: "/images/partners/parceiro-oficialfarma.svg",
      },
      {
        name: "Quatro Folhas",
        description: "Nutrição funcional e fitoterápicos de suporte ao protocolo alimentar.",
  ...
  faq: {
    ...
    items: [
      ...
      {
        question:
          "O que acontece se minha agenda não permitir seguir o protocolo exatamente?",
        answer:
          "O acompanhamento existe para ajustar, não para punir. A disciplina estruturada é um pilar do método exatamente porque a vida real não é linear.",
      },
      {
        question: "Preciso de academia?",
        answer:
          "O programa é otimizado para academia completa. Adaptável a home gym bem equipado.",
      },
      {
        question: "Qual o investimento?",
        answer:
          "O valor é apresentado na entrevista de aprovação, após análise do seu perfil. O ELITE90 PRO é uma consultoria de alto ticket - não um produto de prateleira.",
      },
    ],
  },
  ...
  form: {
    ...
    fields: {
      ...
      age: "Sua idade",
      goal: "Qual é seu principal objetivo?",
      goalOptions: [
      ...
      experience: "Há quanto tempo você treina?",
      experienceOptions: [
        "Menos de 1 ano",
        "1 a 3 anos",
        "3 a 5 anos",
